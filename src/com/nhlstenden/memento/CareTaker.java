...
public class CareTaker {
    ...
    public void saveState(Presentation presentation) {
        ...
        mementoStack.push(new PresentationMemento(presentation.getCurrentSlideNumber(), presentation.getShowList()));
    ...
    public void restoreState(Presentation presentation) {
        ...
        if (!mementoStack.isEmpty()) {
            ...
            System.out.println("After setShowList - show list size: " + presentation.getShowList().size());

            presentation.setCurrentSlideNumber(memento.getSavedSlideNumber());
            System.out.println("After setCurrentSlideNumber - current slide: " + presentation.getCurrentSlideNumber());
