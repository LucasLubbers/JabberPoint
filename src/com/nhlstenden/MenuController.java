...
public class MenuController
{
    ...
    private Menu createEditMenu() {
        ...
        editMenu.add(createMenuItem(SAVE_STATE, new SaveStateCommand(presentation, parent, careTaker), "F5"));
        editMenu.add(createMenuItem(RESTORE_STATE, new RestoreStateCommand(presentation, parent, careTaker), "F9"));
        return editMenu;
    }
