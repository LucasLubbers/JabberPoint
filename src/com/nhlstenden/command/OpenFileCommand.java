...
public class OpenFileCommand implements Command {
    ...
    public OpenFileCommand(Presentation presentation, Frame parent, SlideViewerFrame slideViewerFrame) {
    ...
    public void execute() {
        ...
        if (savedPresentations.isEmpty()) {
            JOptionPane.showMessageDialog(parent, "No saved presentations available.", LOADERR, JOptionPane.ERROR_MESSAGE);
            return;
        }

        String[] names = savedPresentations.keySet().toArray(new String[0]);
        String selectedName = (String) JOptionPane.showInputDialog(parent, "Select a presentation to open:", "Open Presentation", JOptionPane.QUESTION_MESSAGE, null, names, names[0]);
