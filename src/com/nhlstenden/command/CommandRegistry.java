...
public class CommandRegistry {
  ...
  private void initializeCommands(
    ...
    keyCommandMapper.addCommand(
        KeyEvent.VK_O, new OpenFileCommand(presentation, parent, slideViewerFrame));
    keyCommandMapper.addCommand(
        KeyEvent.VK_N, new NewPresentationCommand(presentation, parent, slideViewerFrame));
    ...
    keyCommandMapper.addCommand(
        KeyEvent.VK_F5, new SaveStateCommand(presentation, parent, careTaker));
    keyCommandMapper.addCommand(
        KeyEvent.VK_F9, new RestoreStateCommand(presentation, parent, careTaker));
